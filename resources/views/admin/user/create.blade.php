      ...
      <div class="form-group">
        <div class="form-row">
          ...
          <div class="col-md-6">
            ...
            <input class="form-control" id="surname" name="surname" value="{{old('surname') }}" type="text" aria-describedby="nameHelp" placeholder="Enter last surname">
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-6">
            ...
            <input class="form-control" id="mobile" name="mobile" value="{{old('mobile') }}" type="text" aria-describedby="nameHelp" placeholder="Enter first mobile">
          ...
          <div class="col-md-6">
            ...
            <input class="form-control" id="age" name="age" value="{{old('age') }}" type="text" aria-describedby="nameHelp" placeholder="Enter last age">
            @if ($errors->has('Age'))
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-6">
            ...
            <input class="form-control" id="address" name="address" value="{{old('address') }}" type="text" aria-describedby="nameHelp" placeholder="Enter first address">
